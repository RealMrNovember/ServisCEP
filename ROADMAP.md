...
- **Kapsam**: ilk dilimde yalnızca **Customer + Job** senkronlanıyordu; **dikey dilim 2 (2026-08-24, v0.3.2)** ile kapsam genişletildi:
  ...
  - Hâlâ kapsam dışı: JobNote/Photo/Signature (medya upload senkronu), CustomerLedgerEntries (iki taraf bağımsız hesaplar), tombstone senkronu, mobil çakışma çözüm ekranı.
